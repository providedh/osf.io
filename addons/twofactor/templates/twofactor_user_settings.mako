<div id="twoFactorScope" class="scripted">
  ...
  <div id="TfaVerify" data-bind="visible: !isConfirmed()">
    <p>By using two-factor authentication, you'll protect your PROVIDEDH account with both your password and your mobile phone.</p>
    <div data-bind="visible: isEnabled">
      <div class="alert alert-danger">
        <p><strong>Important: </strong> If you lose access to your mobile device, you will not be able to log in to your PROVIDEDH account.</p>
      </div>
