...
<tr>
  <td style="border-collapse: collapse;">
    ...
    Hello ${fullname},<br>
    <br>
    You have been added by ${referrer.fullname} as a contributor to the project "${node.title}" on the PROVIDEDH Collaborative Platform. To claim yourself as a contributor to the project, visit this url:<br>
    <br>
    ${claim_url}<br>
    <br>
    ...
    The OSF Team<br>
    <br>
    Want more information? Visit https://providedh.ehum.psnc.pl/ to learn about the PROVIDEDH Collaborative Platform, or https://providedh.eu/ for information about the PROVIDEDH CHIST-ERA Project. Questions? Email ${osf_contact_email}<br>
