...
<%def name="content()">
    <div style="margin: 40px;">
        ...
        Hello ${fullname},
        <br><br>
        We’ve noticed it’s been a while since you used the PROVIDEDH Collaborative Platform. We are constantly adding and improving features, so we thought it might be time to check in with you.
        Most researchers begin using PROVIDEDH by creating a project to organize their files and notes. Projects are equipped with powerful features to help you manage your research:
        <br>
        <ul>
            ...
            <li>You can connect to third-party services like GitHub or Google Drive</li>
        </ul>
