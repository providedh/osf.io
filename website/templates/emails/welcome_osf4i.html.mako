...
Learn more about the Open Science Framework at the <a href="http://help.osf.io">Guides page</a>, or email <a href="mailto:${osf_contact_email}">${osf_contact_email}</a> with questions for support.<br>
<br>
Sincerely,<br>
<br>
