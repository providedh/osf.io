...
<%def name="content()">
% if disk_saving_mode:
    <div class="alert alert-info alert-flat"><strong>NOTICE: </strong>Forks and uploads will be temporarily disabled while the PROVIDEDH undergoes a hardware upgrade. These features will return shortly. Thank you for your patience.</div>
% endif
