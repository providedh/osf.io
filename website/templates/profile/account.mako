        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="externalIdentity" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p> Connected identities allow you to log in to the PROVIDEDH via a third-party service. <br/>
                        You can revoke these authorizations here.</p>
                        <hr />
                        % if not external_identity:
                        <p >You have not authorized any external services to log in to the PROVIDEDH.</p>
                        % endif
                        <tbody>
                ...
                <div id="deactivateAccount" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Deactivating your account will remove you from all public projects to which you are a contributor. Your account will no longer be associated with PROVIDEDH projects, and your work on the PROVIDEDH will be inaccessible.</p>
